...
// import {ContainerHeader} from "./StyleComponents/HeaderContainer.style.jsx"
...
const HeaderComponent = () => {
    ...
    return (
        <ContainerHeader>
            ...
            <div className='containerCarrinhoCompras' onClick={() => {
            ...
            {mostrarCarrinho && <CarrinhoCompras setMostrarCarrinho={setMostrarCarrinho} mostrarCarrinho={mostrarCarrinho} />}
